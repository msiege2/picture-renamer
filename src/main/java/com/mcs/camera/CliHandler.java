...
public class CliHandler {
    ...
    private static void printUsage() {
        ...
        System.out.println("  java -jar PictureRenamer.jar rename --source <dir> --dest <dir> --prefix <name> [options]");
        System.out.println();
        System.out.println("  Required:");
        System.out.println("    --source <dir>               Source directory containing photos");
        System.out.println("    --dest <dir>                 Destination base directory (e.g., F:\\My Pictures)");
        System.out.println("    --prefix <name>              Album name prefix");
        System.out.println();
        System.out.println("  Optional:");
        System.out.println("    --force-date <yyyy-MM-dd>    Force a specific date (also sets album dir name)");
        System.out.println("    --keep-order                 Keep original file order (natural sort, skips metadata)");
        System.out.println("    --include-videos             Include video files");
        System.out.println("    --inline-videos              Sort videos by date alongside photos (requires --include-videos)");
        System.out.println("    --try-filename-date          Try parsing date from filename when metadata fails");
        System.out.println("    --counter-start <n>          Starting counter (default: 1)");
        System.out.println("    --number-padding <n>         Number padding digits: 2, 3, or 4 (default: 3)");
        System.out.println("    --separator <type>           Filename separator: space, dash, underscore, none (default: space)");
        System.out.println("    --dry-run                    Show what would happen without making changes");
        System.out.println();
        System.out.println("Renumber command:");
        System.out.println("  java -jar PictureRenamer.jar renumber --dir <dir> --prefix <name> [options]");
        System.out.println();
        System.out.println("  Required:");
        System.out.println("    --dir <dir>                  Directory to renumber");
        System.out.println("    --prefix <name>              New filename prefix");
        System.out.println();
        System.out.println("  Optional:");
        System.out.println("    --include-videos, --inline-videos, --number-padding, --separator, --dry-run");
        System.out.println("    (same as rename)");
    }
}
